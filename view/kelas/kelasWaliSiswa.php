			...
			<div class="col-md-12">
				<div class="d-sm-flex mb-3">
					<div class="col-10 d-flex">
						<h1 class="h2 mb-0 ml-4 text-dark font-weight-bold cap">Data Wali Kelas Siswa</h1>
					</div>
				</div>
							...
							<tbody>
								...
								while ($data = mysqli_fetch_assoc($query)) { ?>
									<tr>
										...
										<td width="180"class="center"><?php echo $data['tempat_lahir']; ?>, <?php echo date('d-m-Y', strtotime($data['tanggal_lahir'])); ?></td>
										<td width="120"class="center"><?php echo $data['jenis_kelamin']; ?></td>
										<td width="100"class="center"><?php echo $data['agama']; ?></td>
										<td width="180"class="center"><?php echo $data['alamat']; ?></td>
	...
	<?php
		...
		<script>
			document.location = 'index.php?alert=55';
		</script>
	<?php
