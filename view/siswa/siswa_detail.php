    ...
    <div class="col-md-12">
        <div class="d-sm-flex mb-2 ml-4 ">
            <div class="col-11 d-flex">
                <a href="?page=siswa" class="btn-circle btn-dark text-warning animated bounceInLeft delay-1s">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <h1 class="h2 mb-0 ml-4 text-dark font-weight-bold cap bounceIn">Detail Siswa</h1>
            </div>
        </div>
        <div class="d-sm-flex justify-content-between mb-0">
            <div class="col-lg-9 mb-4">
                ...
                <div class="card shadow border-bottom-warning mb-4 animated bounceIn">
                    <div class="card-header py-3 bg-warning">
                        <h4 class="mm-0 font-weight-bold text-dark text-center cap ">Biodata Siswa</h4>
                    </div>
                    <div class="card-body bg-dark text-warning d-sm-flex">
                        ...
                        <div class="col-lg-5 mt-3 ml-5">
                            ...
                            <!-- Judul Buku -->
                            <div class="form-group"><label class="cap font-weight-bold" style="font-size: 20px;">Nama Siswa</label>
            ...
            <div class="col-lg-3 mb-4">
                ...
                <div class="col d-flex justify-content-center animated bounceInDown delay-2s"><a title=" Hapus" class="btn1 btn-dark text-warning " id="btn-del" href="siswa_proses_hapus.php?nim=<?php echo $data['nim']; ?>"><i class="fas fa-trash"></i></a>
                </div>
            </div>
