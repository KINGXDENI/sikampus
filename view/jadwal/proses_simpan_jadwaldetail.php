    ...
    if (isset($_POST['simpan'])) {
        ...
        // jika kode_jadwal belum ada  
            ...
            // upload file
                ...
                $insert = mysqli_query($db, "INSERT INTO tbl_jadwaldetail(kode_jadwal,id_waktu,kode_mapel,kode_kelas,nip,tahun_ajaran)
VALUES('$kode_jadwal','$id_waktu','$kode_mapel','$kode_kelas','$nip','$tahun_ajaran')")
